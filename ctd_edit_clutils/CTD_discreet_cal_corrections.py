...
parser = argparse.ArgumentParser(description='Apply corrections from Discreet oxygen or salinity samples')
parser.add_argument('DataPath', metavar='DataPath', type=str, help='full path to directory for cruise')
parser.add_argument('--primary_oxygen', nargs='+', type=float, help='apply linear correction to primary oxygen')
parser.add_argument('--secondary_oxygen', nargs='+', type=float, help='apply linear correction to secondary oxygen')
parser.add_argument('--primary_salinity', type=float, help='apply offset correction to primary salinity')
parser.add_argument('--secondary_salinity', type=float, help='apply offset correction to secondary salinity')
parser.add_argument('--fluorometer', type=float, help='apply offset correction to fluorometer (0.0 - deep noise)')
    ...
    for ifile, ncfile in enumerate(full_path):
        ...
        for i in range(1,10):
            ...
            if ('EDIT_CMNT0'+str(i)) in global_atts.keys():
                ...
                nchandle.setncattr('EDIT_CMNT01','Primary Oxygen Cal Factor of: ' + str(args.primary_oxygen[0])\
                                     +'x + ' + str(args.primary_oxygen[1]) + ' applied' )
        nchandle.close()
...
if args.secondary_oxygen: #CTDOXY_4221
    for ifile, ncfile in enumerate(full_path):
        ...
        O2corr = (data['CTDOXY_4221'] * args.secondary_oxygen[0]) + args.secondary_oxygen[1]
        ...
        for i in range(1,10):
            ...
            if ('EDIT_CMNT0'+str(i)) in global_atts.keys():
                ...
                nchandle.setncattr('EDIT_CMNT01','Secondary Oxygen Cal Factor of: ' + str(args.secondary_oxygen[0])\
                                     +'x + ' + str(args.secondary_oxygen[1]) + ' applied' )
    ...
    for ifile, ncfile in enumerate(full_path):
        ...
        for i in range(1,10):
            ...
            if ('EDIT_CMNT0'+str(i)) in global_atts.keys():
                ...
                nchandle.setncattr('EDIT_CMNT01','Primary Salinity Cal Factor of: ' + str(args.primary_salinity) + ' applied' )
    ...
    for ifile, ncfile in enumerate(full_path):
        ...
        for i in range(1,10):
            ...
            if ('EDIT_CMNT0'+str(i)) in global_atts.keys():
                ...
                nchandle.setncattr('EDIT_CMNT01','Secondary Salinity Cal Factor of: ' + str(args.secondary_salinity) + ' applied' )
    ...
    for ifile, ncfile in enumerate(full_path):
        ...
        for i in range(1,10):
            ...
            if ('EDIT_CMNT0'+str(i)) in global_atts.keys():
                ...
                nchandle.setncattr('EDIT_CMNT01','Fluorometer offset of: ' + str(args.fluorometer) + ' applied' )
